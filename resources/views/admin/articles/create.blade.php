...
<div class="glass-card max-width-800 mx-auto">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h5 class="mb-0 fw-bold">Create New Article</h5>
    ...
    <form method="POST" action="{{ route('admin.articles.store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control bg-dark text-white border-secondary" id="title" name="title" value="{{ old('title') }}" required placeholder="Enter article title...">
        </div>
        ...
        <div class="mb-4">
            ...
            <textarea class="form-control bg-dark text-white border-secondary" id="body" name="body" rows="10" required placeholder="Write article content here..." style="resize: vertical;">{{ old('body') }}</textarea>
        </div>

        <button type="submit" class="btn btn-primary w-100 py-2 fw-bold"><i class="fa-solid fa-save"></i> Publish Article</button>
    </form>
</div>
@endsection
